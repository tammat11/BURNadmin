...
(function () {
  ...
  var DICT = {
    kk: {
      ...
      heroTitle: "Бизнесін<br>құрғандар <em>клубы</em>",
      heroLede: "Курс емес, билет бойынша нетворкинг емес, суық хат тарататын чат емес. Жұмыс істеп тұрған бизнесі бар кәсіпкерлер ортасы; мұнда өтінім, жеке кездесу және кеңес шешімі арқылы кіреді.",
      heroHint: "Алдымен адал сүзгі — кімге бұл жер керек емес",
      ...
      whoTag: "Адал сүзгі", whoTitle: "Алдымен кімге бұл жер керек емес екені туралы",
      whoNote: "Жабық клуб артықшылықтар тізімімен емес, ішінде кім жоқ екенімен ұсталады. Оң жақ бағанды бірінші оқыңыз: өзіңізді танысаңыз — өзіңіздің де, кеңестің де уақытын үнемдейсіз.",
      fitYes: "Сізге осында", fitNo: "Сізге бұл жер емес",
      yes1: "Сізде жұмыс істеп тұрған бизнес бар, презентация сатысындағы идея емес.",
      ...
      no2: "Әзірге түсімі жоқ идеяға инвестор іздеп жүрсіз.",
      ...
      beatMonthly: "Ай сайын", beatQuarterly: "Тоқсанына бір рет",
      beatByRequest: "Сұраныс бойынша", beatSeason: "Маусымға қарай",
      beat1H: "Директорлар кеңесі", beat1P: "Резиденттер сұраныстарын талдау және клуб бойынша шешімдер. Ресми бөлім — алкогольсіз.",
      beat2H: "Бизнес-таңғы астар", beat2P: "Таң, шағын құрам, нақты міндеттер және тәжірибе алмасу.",
      beat3H: "Талдаулар және стратегиялық сессиялар", beat3P: "Бір компания, бір сұрақ, тығыз жұмыс кеші.",
      beat4H: "Спикерлермен кездесулер", beat4P: "Кітаптан оқуға болмайтын тәжірибесі бар адамдар.",
      beat5H: "Спорт және сапарлар", beat5P: "Футбол, жүгіру, балық аулау, аңшылық, ерлер сапарлары.",
      beat6H: "Отбасы күндері", beat6P: "Клуб берік отбасыны қолдайды, одан алыстатпайды.",
      ...
      a1: "Қатысу шарттарын клуб менеджері өтінімнен кейінгі қоңырауда айтады — мүшелікке не кіретінін және жеке іс-шаралар қалай төленетінін қоса. Барлық сома теңгемен.",
      q2: "Барлық кездесуге қатысу міндетті ме?",
      a2: "Жоқ, бірақ қатысу тәртібі — Кодекстің жеке бөлімі. Клуб келетіндермен ұсталады; жүйелі түрде келмеу кеңесте талқыланады.",
    ...
    en: {
      ...
      heroTitle: "A club for those<br>who have already <em>built</em>",
      heroLede: "Not a course, not networking by ticket, not a chat full of cold outreach. A circle of entrepreneurs with a running business, entered by application, a personal meeting and a decision of the council.",
      heroHint: "First an honest filter — who should not be here",
      ...
      whoTag: "An honest filter", whoTitle: "First, who should not be here",
      whoNote: "A private club is held together not by a list of perks but by who is kept out. Read the right-hand column first: if you recognise yourself, you save your own time and the council's.",
      fitYes: "This is for you", fitNo: "This is not for you",
      yes1: "You have a business that is running, not an idea at the deck stage.",
      ...
      no2: "You are looking for an investor for an idea that has no revenue yet.",
      ...
      beatMonthly: "Monthly", beatQuarterly: "Quarterly",
      beatByRequest: "On request", beatSeason: "Seasonal",
      beat1H: "Board meeting", beat1P: "A review of residents' requests and decisions about the club. The formal part is alcohol-free.",
      beat2H: "Business breakfasts", beat2P: "Morning, a small group, concrete problems and shared practice.",
      beat3H: "Case reviews and strategy sessions", beat3P: "One company, one question, an evening of dense work.",
      beat4H: "Speaker evenings", beat4P: "People with experience you cannot get from a book.",
      beat5H: "Sport and trips", beat5P: "Football, races, fishing, hunting, trips for the men of the club.",
      beat6H: "Family days", beat6P: "The club supports strong families rather than pulling people away from them.",
      ...
      a1: "The club manager gives you the terms on the call after your application, together with what membership includes and how individual events are paid for. All amounts are in tenge.",
      q2: "Do I have to attend everything?",
      a2: "No, but attendance discipline is its own section of the Code. The club is held up by the people who show up; a pattern of absences is discussed by the council.",
  ...
  var STORE = "burn.lang";
  var TITLES = {
    kk: { index: "BURN — кәсіпкерлердің жабық қауымдастығы, Алматы", code: "Резидент кодексі — BURN" },
    en: { index: "BURN — a private community of entrepreneurs, Almaty", code: "Resident Code — BURN" },
  };
  ...
  function apply(lang) {
    ...
    var note = document.querySelector('[data-i18n="codeAuthentic"]');
