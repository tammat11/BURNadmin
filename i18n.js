...
(function () {
  ...
  var DICT = {
    kk: {
      ...
      heroTitle: "Шешім<br>қабылдайтын <em>орта</em>",
      heroLede: "BURN — бизнесін құрып үлгерген кәсіпкерлер қауымдастығы. Орта, мәмілелер, шешімдер. Кіру — өтінім және жеке кездесу арқылы. Мұнда «қарап шығуға» келмейді.",
      heroHint: "Төмен қараңыз — клубқа апарар төрт қадам",
      ...
      cardFoot: "Іс-шаралар мен артықшылықтар резиденттің қаласы бойынша көрсетіледі. Жаңа қалалар құрам жиналған сайын ашылады.",
      ...
      pathNote: "Екі тарап та шешеді. Клуб адамның шеңберге сай-сай еместігін қарайды, адам — клубтың өзіне сай екенін. Әр қадамда тоқтауға болады.",
      ...
      docTag: "Клуб құжаты",
      codeNote: "Мұнда өзін қалай ұстау керегі туралы он екі бөлім: ресми кездесулердегі сергектіктен толық құпиялылыққа дейін. Үміткер өтінім бермес бұрын Кодексті оқиды, онымен келісім құжат нұсқасымен бірге тіркеледі.",
    ...
    en: {
      ...
      heroTitle: "The circle<br>where things get <em>decided</em>",
      heroLede: "BURN is a community of entrepreneurs who have already built a business. Peers, deals, decisions. Entry is by application and a personal meeting. Nobody drops in just to look around.",
      heroHint: "Scroll — four steps into the club",
      ...
      cardFoot: "Events and privileges are shown for the resident's own city. New cities open as their membership fills up.",
      ...
      pathNote: "Both sides decide. The club looks at whether the person fits the circle; the person looks at whether the club fits them. You can stop at any step.",
      ...
      codeNote: "Twelve sections on how things are done here, from staying sober at formal meetings to complete confidentiality. A candidate reads the Code before applying, and their agreement is recorded together with the version of the document.",
